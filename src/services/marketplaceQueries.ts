...
query GetProductWithPartner($productId:ID!) {
  getProductWithPartner(productId:$productId) {
    id
    name   
    partner {
      id
...
export { GET_PRODUCTS, GET_FACETS, GET_PRODUCT, GET_ALL_COURSES, GET_COURSE, GET_PARTNER, BOOKMARK_SERVICE };
