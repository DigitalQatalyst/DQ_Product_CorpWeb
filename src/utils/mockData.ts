...
export const mockCourses: CourseType[] = [
  {
    id: "1",
    title: "Business Plan Development: Creating a Comprehensive Strategy for Funding and Growth",
    description:
  ...
  {
    id: "2",
    title: "Financial Management for SMEs: Mastering Budgeting, Cash Flow, and Strategic Planning",
    description:
  ...
  {
    id: "3",
    title: "Digital Marketing Fundamentals: SEO, Social Media, and Content Strategy for Growth",
    description:
  ...
  {
    id: "4",
    title: "Leadership Excellence: Developing Skills for Team Management and Organizational Success",
    description:
  ...
  {
    id: "5",
    title: "Compliance and Legal Essentials: Navigating UAE Business Laws and Regulations",
    description:
