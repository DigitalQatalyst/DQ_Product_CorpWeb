...
export const dqProducts: ProductType[] = [
  ...
  },
  {
    ...
    tags: ["Actionable Insights", "Bite-Sized Learning", "Practical Case Studies"],
  ...
  },
  {
    ...
    code: "DWS",
    description:
      "In Economy 4.0, success requires digital workers—professionals who thrive through human-machine collaboration. Digital Working Studios (DWS) empowers this new workforce with spaces designed for AI-augmented productivity.",
  ...
  },
  {
    ...
    code: "DTMI",
    description:
      "Global digital transformation management insights platform structured by 6xD and sector lenses. Access research-driven insights, articles, case studies, and digital transformation content from industry experts.",
  ...
  },
  {
    ...
    tags: ["Asset Management", "Operational Efficiency", "Sustainability Focus"],
