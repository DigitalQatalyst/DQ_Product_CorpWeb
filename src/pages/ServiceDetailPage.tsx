...
const serviceData: Record<string, any> = {
  ...
  "experience-4-0": {
    ...
    faqs: [
      {
        question: "How does Experience4.0 improve customer satisfaction?",
        answer: "Experience4.0 leverages AI, data analytics, and omnichannel strategies to deliver seamless, personalized interactions, ensuring customers feel understood and valued at every touchpoint."
      },
      {
        question: "What technologies are used in Experience4.0?",
      ...
      {
        question: "How long does it take to see results from Experience4.0 implementation?",
  ...
  "agility-4-0": {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: "Organisations typically begin seeing measurable improvements in responsiveness and efficiency within 3–6 months of implementing Agility4.0, depending on the scope and scale of adoption."
      }
    ]
  },
  "farming-4-0": {
    ...
    faqs: [
      ...
      {
        question: "How does Farming4.0 help with market access?",
  ...
  "infrastructure-4-0": {
    ...
    faqs: [
      {
        question: "How does Infrastructure4.0 drive ROI?",
        answer: "Infrastructure4.0 drives ROI by reducing operational costs through predictive maintenance, optimizing resource usage with IoT and AI, and improving project efficiency. Smart technologies minimize downtime, extend asset lifecycles, and enable data-driven decision-making that leads to significant cost savings and new revenue opportunities through smart city platforms and services."
      },
      {
        question: "What industries benefit from Infrastructure4.0?",
      ...
      },
      {
        ...
        answer: "Initial results from Infrastructure4.0 implementation can be seen within 3-6 months, with quick wins in monitoring and efficiency improvements. Full transformation benefits, including significant cost reductions and optimized operations, are typically realized within 12-18 months depending on the scope and scale of implementation."
      }
    ]
  },
  "government-4-0": {
    ...
    faqs: [
      {
        question: "How does Government4.0 drive ROI?",
        answer: "Government4.0 drives ROI by reducing operational costs through automation, improving service delivery efficiency, and generating new revenue streams through digital services. By streamlining administrative processes, reducing manual interventions, and enabling data-driven decision-making, governments can achieve significant cost savings while improving citizen satisfaction and trust."
      },
      {
        question: "What challenges does Government4.0 solve?",
        answer: "Modernize outdated systems, enhance citizen engagement, and ensure secure, transparent governance through innovative digital tools. Government4.0 addresses challenges such as bureaucratic inefficiencies, lack of transparency, poor citizen engagement, data silos, and security vulnerabilities by implementing integrated digital platforms, blockchain for transparency, AI for decision-making, and secure identity management systems."
      },
      {
        question: "How quickly can I see results?",
        answer: "Initial results from Government4.0 implementation can be seen within 3-6 months for pilot projects and quick wins like digital portals and automated workflows. Full transformation benefits, including comprehensive digital governance, improved citizen satisfaction, and significant cost reductions, are typically realized within 12-24 months depending on the scope and scale of implementation."
      }
    ]
  },
  "hospitality-4-0": {
    ...
    faqs: [
      ...
      {
        question: "What technologies are used in Hospitality4.0?",
      ...
      {
        question: "How long does it take to see results from Hospitality4.0 implementation?",
        answer: "Initial results from Hospitality4.0 implementation can be seen within 2-4 months, with quick wins in guest satisfaction scores and operational efficiency. Full transformation benefits, including significant revenue growth, optimized operations, and enhanced guest loyalty, are typically realized within 6-12 months depending on the scope of implementation."
      }
    ]
  },
  "retail-4-0": {
  ...
  "service-4-0": {
    ...
    faqs: [
      {
        question: "How does Services4.0 drive ROI?",
        answer: "Services4.0 drives ROI by automating repetitive tasks, reducing operational costs, and improving service delivery efficiency. AI-driven insights enable better decision-making, while digital integration streamlines workflows and enhances customer experiences. Organizations typically see 20-40% cost reductions and significant improvements in service quality within 6-12 months."
      },
      {
        question: "What challenges does Services4.0 solve?",
        answer: "Modernize outdated processes, streamline operations, and deliver personalized, tech-driven solutions that set your business apart from competitors. Services4.0 addresses challenges such as manual processes, data silos, poor customer engagement, compliance risks, and high operational costs by implementing integrated digital platforms, AI automation, and real-time analytics."
      },
      {
        question: "How quickly can I see results?",
        answer: "Initial results from Services4.0 implementation can be seen within 2-4 months, with quick wins in process automation and customer engagement. Full transformation benefits, including significant cost reductions, improved operational efficiency, and enhanced service delivery, are typically realized within 6-12 months depending on the scope and scale of implementation."
      }
    ]
  },
  "logistics-4-0": {
    ...
    faqs: [
      {
        question: "How does Logistics4.0 drive ROI?",
        answer: "Logistics4.0 drives ROI by reducing operational costs through route optimization, fuel efficiency, and automated processes. Real-time tracking and predictive maintenance minimize delays and downtime, while AI-driven insights improve supply chain efficiency. Organizations typically see 20-35% cost reductions and significant improvements in delivery times and customer satisfaction within 6-12 months."
      },
      {
        question: "What challenges does Logistics4.0 solve?",
        answer: "Modernize outdated logistics systems, streamline supply chains, and deliver seamless, tech-driven solutions that set your business apart from competitors. Logistics4.0 addresses challenges such as poor visibility, inefficient routing, high fuel costs, delayed deliveries, inventory mismanagement, and lack of transparency by implementing integrated IoT, AI, and blockchain solutions."
      },
      {
        question: "How quickly can I see results?",
        answer: "Initial results from Logistics4.0 implementation can be seen within 2-4 months, with quick wins in tracking visibility and route optimization. Full transformation benefits, including significant cost reductions, improved delivery times, and enhanced supply chain efficiency, are typically realized within 6-12 months depending on the scope and scale of implementation."
      }
    ]
  },
  "wellness-4-0": {
    icon: Heart,
    title: "Healthcare & Wellness 4.0",
    ...
    overviewText: "Transform health and wellness with Wellness4.0, leveraging AI, IoT, and telehealth to deliver personalized, accessible care. From remote patient monitoring and chronic disease management to mental health support and elderly care, our solutions enhance well-being while optimizing operational efficiency. Elevate your services with cutting-edge digital tools designed to improve lives and streamline care delivery.",
    ...
    faqs: [
      {
        question: "How does Wellness4.0 improve patient care?",
        answer: "Wellness4.0 improves patient care by enabling remote monitoring, virtual consultations, and personalized treatment plans through AI and IoT technologies. Patients receive timely interventions, better chronic disease management, and enhanced access to healthcare services, leading to improved outcomes and satisfaction."
      },
      {
        question: "What technologies are used in Wellness4.0?",
        answer: "Wellness4.0 utilizes AI for diagnostics and personalized care, IoT for remote patient monitoring, telehealth platforms for virtual consultations, wearable devices for health tracking, and integrated digital platforms for seamless care coordination. These technologies work together to deliver comprehensive, accessible healthcare solutions."
      },
      {
        question: "How quickly can I see results?",
        answer: "Initial results from Wellness4.0 implementation can be seen within 2-4 months, with quick wins in patient engagement and remote monitoring capabilities. Full transformation benefits, including improved patient outcomes, reduced costs, and enhanced operational efficiency, are typically realized within 6-12 months depending on the scope of implementation."
      }
    ]
  },
  "intelligence-4-0": {
    ...
    benefits: [
      {
        ...
        description: "Enable seamless teamwork across locations with integrated digital collaboration tools."
      },
      {
        icon: TrendingUp,
        title: "Increased Productivity",
        description: "Boost employee efficiency with intelligent automation and streamlined workflows."
      },
      {
        icon: UsersRound,
        title: "Employee Engagement",
        description: "Improve satisfaction and retention with modern, flexible work environments."
      },
      {
        icon: DollarSign,
        title: "Cost Optimization",
        description: "Reduce operational costs through digital transformation and workspace optimization."
      }
    ],
    whereToStart: [
      {
    ...
    benefits: [
      {
        ...
        description: "Ensure adherence to regulations with automated compliance monitoring and reporting."
      },
      {
        icon: TrendingUp,
        title: "Risk Management",
        description: "Identify, assess, and mitigate risks proactively with intelligent risk management systems."
      },
      {
        icon: UsersRound,
        title: "Strategic Alignment",
        description: "Align governance practices with business objectives for consistent strategic execution."
      },
      {
        icon: DollarSign,
        title: "Operational Efficiency",
        description: "Streamline governance processes and reduce compliance costs through automation."
      }
    ],
    whereToStart: [
      {
    ...
    benefits: [
      {
        ...
        description: "Automate repetitive tasks and workflows to reduce manual effort and errors."
      },
      {
        icon: TrendingUp,
        title: "Operational Efficiency",
        description: "Streamline operations and accelerate processing times with intelligent systems."
      },
      {
        icon: UsersRound,
        title: "Resource Optimization",
        description: "Free up staff to focus on strategic work by automating routine back-office tasks."
      },
      {
        icon: DollarSign,
        title: "Cost Reduction",
        description: "Significantly reduce operational costs through automation and process optimization."
      }
    ],
    whereToStart: [
      {
      ...
      <section className="relative h-[520px] overflow-hidden bg-secondary-900">
        ...
        <div className="relative container mx-auto px-4 h-full flex flex-col justify-center text-white">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <Link
              to="/about-us"
              className="px-8 py-3 border-2 border-white text-white font-semibold rounded-full hover:bg-white/10 transition-colors inline-flex items-center justify-center"
            >
              About
            </Link>
          </div>
      ...
      <section className="relative h-[400px] bg-gray-900">
        ...
        <div className="relative container mx-auto px-4 h-full flex flex-col justify-center">
          ...
          <div className="absolute bottom-6 left-4 text-white/70 text-sm">
            ...
            <Link to="/services" className="hover:text-white">Industry</Link>
            <span className="mx-2">›</span>
              ...
              <div className="mb-16">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                  {service.serviceAreas.map((area: any, index: number) => (
                    <div 
                      key={index} 
                      className="group relative border border-gray-200 rounded-xl p-6 hover:shadow-lg transition-all duration-300 overflow-hidden cursor-pointer"
                    >
                      {/* Animated background overlay */}
                      <div className="absolute inset-0 bg-gradient-to-r from-secondary-900/90 to-secondary-800/90 transform -translate-x-full group-hover:translate-x-0 transition-transform duration-500 ease-out"></div>
