...
import {CheckCircleIcon, ChevronDownIcon, ChevronUpIcon, SaveIcon, XIcon,} from 'lucide-react';
    ...
    return (
        <div className="space-y-4">
                    ...
                    >
                                        ...
                                        <div className="ml-2 flex items-center">
                                            {groupMandatoryCompletion.percentage === 100 ? (
                                                ...
                                                <span
                                                    ...
                                                    <span
                                                        className="w-2 h-2 rounded-full bg-amber-500 mr-1 flex-shrink-0"></span>
                        ...
                        {isExpanded && (
                            ...
                            >
                                            ...
                                            return (
                                                ...
                                                >
                                                    <div
                                                        ...
                                                        <div
                                                            className="text-sm flex-shrink-0 sm:w-1/3 pr-2 sm:pr-4 mb-1 sm:mb-0">
                                                            <span
                                ...
                                {isEditing && (
                                    <div
                                        className="mt-4 flex flex-col sm:flex-row sm:justify-end space-y-2 sm:space-y-0 sm:space-x-2 border-t border-gray-100 pt-4">
                                        <button
            ...
            {(!config || config.length === 0) && (
                <div
                    className="py-8 sm:py-10 md:py-12 text-center bg-gray-50 rounded-lg border border-dashed border-gray-300">
