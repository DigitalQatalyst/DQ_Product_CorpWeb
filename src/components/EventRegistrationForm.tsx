...
const EventRegistrationForm: React.FC<EventRegistrationFormProps> = ({
  ...
  console.log('EventRegistrationForm rendering with event:', event);
  ...
  if (!event) {
    console.error('EventRegistrationForm: No event data provided')
    return null
  }
  return (
    <div
    ...
    >
      <div
        className="bg-white rounded-xl shadow-2xl max-w-lg w-full max-h-[90vh] overflow-y-auto animate-scaleIn relative"
      ...
      >
        ...
        <div className="relative p-6 border-b border-gray-200 bg-blue-50">
          <button
            onClick={onClose}
            className="absolute right-6 top-6 text-gray-400 hover:text-gray-600 transition-colors bg-white rounded-full p-1"
          ...
          <p className="text-sm text-gray-600 mt-1">Please fill out the form below to register</p>
        </div>
        {/* Event Details */}
