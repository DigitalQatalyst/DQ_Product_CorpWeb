import { Calendar, Clock, User, TrendingUp, Target, DollarSign, Users, Mail, Linkedin, Twitter, Share2, Download, Bookmark, Lightbulb, BarChart3, AlertCircle, Zap, UserCheck, Shield, Eye } from 'lucide-react';
...
const ExecutiveSummary = ({ summary, keyInsights }: any) => (
  <motion.div 
    className="bg-gray-50 rounded-xl shadow-sm border border-gray-200 p-8 mb-8"
              ...
              <div className="ml-20">
                ...
                >
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <motion.div 
                      className="inline-flex items-center gap-2 px-3 py-1 bg-blue-600 text-white text-sm font-semibold rounded-full"
...
const PredictionMetrics = ({ metrics }: any) => {
  ...
  return (
    <motion.div 
      className="bg-gray-50 rounded-xl shadow-sm border border-gray-200 p-8"
      initial="hidden"
      whileInView="visible"
      viewport={{ once: true, amount: 0.3 }}
      variants={containerVariants}
        ...
        {metrics.map((metric: any, index: number) => (
          ...
          >
            ...
            <p className={`text-sm leading-relaxed ${
              metric.trend === 'warning' ? 'text-orange-600' : 'text-cyan-600'
            }`}>
              {metric.description}
            </p>
          </motion.div>
      ...
      <div className="flex space-x-1 mb-6 bg-gray-100 p-1 rounded-lg">
        {scenarios.map((scenario: any, index: number) => (
          <motion.button
            ...
            className={`flex items-center gap-2 px-4 py-2 rounded-md text-sm font-medium transition-all duration-200 border-2 ${getTabColor(scenario, activeTab === index)}`}
...
const SignalsTracking = ({ signals }: any) => {
  ...
  const getSignalIcon = (category: string) => {
    switch (category.toLowerCase()) {
      case 'technology': return <Zap size={20} className="text-blue-500" />;
  ...
  const getStrengthBadge = (strength: string, impact: string) => {
    const strengthColor = strength === 'Strong' ? 'bg-teal-500' : 
                         strength === 'Moderate' ? 'bg-blue-500' : 'bg-gray-500';
    const impactColor = impact === 'High Impact' ? 'bg-pink-500' : 
      ...
      <div className="space-y-4">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mt-6">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h4 className="font-semibold text-blue-900 mb-2">Monitoring Recommendation</h4>
          ...
          >
            ...
            <div className="relative aspect-[4/3] overflow-hidden bg-black rounded-2xl">
              ...
              <button
                ...
                className="absolute top-4 right-4 w-12 h-12 rounded-full flex items-center justify-center bg-white text-gray-600 hover:bg-gray-50 transition-all duration-200 shadow-lg"
            ...
            <div className="p-5">
              ...
              <h3 className="font-bold text-gray-900 text-lg leading-tight mb-3">
                The Rise of Digital Cognitive Organizations: 2025-2030 Outlo...
              </h3>

              {/* Description */}
              <p className="text-gray-500 text-sm leading-relaxed mb-4">
                An in-depth prediction analysis of how AI-driven cognitive architectures will...
              </p>

              {/* Date */}
              <p className="text-gray-400 text-xs">Jan 15, 2025</p>
            </div>
          </div>
        ))}
      </div>
...
const PredictionAnalysisDetail = () => {
  ...
  const predictionData = {
    ...
    predictionMetrics: [
      ...
      },
      {
        ...
        percentage: 75,
        trend: "up",
        description: "Average improvement from AI-driven operations"
      },
      {
    ...
    timeline: [
      ...
      },
      {
        ...
        description: "Full-scale deployment of DCOs within large enterprises. Human roles evolve, with cognitive agents handling administrative and operational tasks.",
        milestones: [
  ...
  return (
    <div className="min-h-screen" style={{ fontFamily: '"Segoe UI", Tahoma, Geneva, Verdana, sans-serif' }}>
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-0 pt-[35vh] pb-20">
          <div className="max-w-5xl -ml-4">
            ...
            {/* Subtitle */}
            <motion.p 
              className="text-base md:text-lg text-gray-500 mb-5 leading-relaxed max-w-3xl"
              initial={{ y: 30, opacity: 0 }}
              animate={{ y: 0, opacity: 1 }}
            ...
            <motion.div 
              className="flex flex-wrap items-center gap-5 text-sm text-gray-400 mb-5"
              initial={{ y: 30, opacity: 0 }}
              animate={{ y: 0, opacity: 1 }}
            ...
            >
              <motion.button
                className="flex items-center gap-2 px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded hover:bg-blue-700 transition-all duration-300"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              >
                <Share2 size={16} />
              ...
              <motion.button
                className="flex items-center gap-2 px-4 py-2 bg-transparent text-gray-600 text-sm font-medium rounded border border-gray-300 hover:bg-gray-50 transition-all duration-300"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              >
                <Download size={16} />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
            ...
            <div className="space-y-8">
              ...
              >
                ...
                <motion.button 
                  className="w-full bg-white text-blue-600 font-semibold py-2 px-4 rounded-lg"
                  whileHover={{ 
                    scale: 1.05, 
              ...
              <div className="bg-white rounded-xl shadow-lg p-8">
                ...
                <div className="space-y-8">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed mb-4">
                      Data Privacy and Security remain paramount concerns as organizations adopt cognitive technologies. Businesses must 
                      invest in advanced cybersecurity measures and adhere to international data protection regulations to avoid breaches 
                      and loss of trust. The rise of AI decision-making also brings concerns regarding accountability—DCOs must ensure 
                      their AI systems are explainable and transparent.
                    </p>
                    <p className="text-gray-700 leading-relaxed">
