...
export const MarketplaceRouter: React.FC = () => {
  ...
  const knowledgeHubConfig = getMarketplaceConfig('dtmi'); // Using dtmi config for knowledge-hub
  ...
  return <Routes>
      ...
      <Route path="/knowledge-hub" element={<MarketplacePage marketplaceType="dtmi" title={knowledgeHubConfig.title} description={knowledgeHubConfig.description} promoCards={knowledgeHubPromoCards} />} />
      <Route path="/knowledge-hub/:itemId" element={<MarketplaceDetailsPage marketplaceType="dtmi" bookmarkedItems={bookmarkedItems['knowledge-hub']} onToggleBookmark={itemId => handleToggleBookmark('knowledge-hub', itemId)} />} />
      
      {/* Prediction Analysis Detail Page */}
      <Route path="/knowledge-hub/prediction-analysis" element={<PredictionAnalysisDetail />} />
    </Routes>;
};
